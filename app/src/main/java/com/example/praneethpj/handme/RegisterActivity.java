...
public class RegisterActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Registertype=(Spinner)findViewById(R.id.spiner) ;
        ...
        btnRegister.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                String type = inputPassword.getText().toString().trim();
                String name = inputFullName.getText().toString().trim();
                String email = inputEmail.getText().toString().trim();
                String password = inputPassword.getText().toString().trim();

                if (!type.isEmpty()&&!name.isEmpty() && !email.isEmpty() && !password.isEmpty()) {
                    registerUser(type,name, email, password);
                } else {
     ...
     * */
    private void registerUser(final String type,final String name, final String email,
